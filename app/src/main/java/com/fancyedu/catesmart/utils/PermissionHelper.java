...
public class PermissionHelper {
        ...
        new AlertDialog.Builder(getActivity(mContext))
                ...
                .setNegativeButton("退出", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (dialogCanceListener != null) {
                            dialogCanceListener.cancerCallBack();
                        } else {
                            if (mContext instanceof Activity) {
                                ((Activity) mContext).finish();
                            } else if (mContext instanceof Fragment) {
                                ((Fragment) mContext).getActivity().finish();
                            }
                        }
    ...
    DialogCanceListener dialogCanceListener;

    public void setDialogCanceListener(DialogCanceListener dialogCanceListener) {
        this.dialogCanceListener = dialogCanceListener;
    }
